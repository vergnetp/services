...
async def chat(
    ...
    if "search_documents" in tools_list:
        try:
            from shared_libs.backend.ai.ai_agents.tools import set_document_context, clear_sources
    ...
    if "search_documents" in tools_list:
        try:
            from shared_libs.backend.ai.ai_agents.tools import get_sources
...
async def chat_websocket(websocket: WebSocket, thread_id: str, token: str = None):
    ...
    try:
        ...
        if not settings.auth_enabled:
            ...
            from shared_libs.backend.auth import User
