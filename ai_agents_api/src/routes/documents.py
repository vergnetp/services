...
async def get_ollama_status():
    ...
    try:
        from shared_libs.backend.ai.ollama import is_available_async, list_models_async, RECOMMENDED_MODELS, DEFAULT_MODEL
...
async def pull_ollama_model(model: str = Query(default="qwen2.5:3b")):
    ...
    try:
        from shared_libs.backend.ai.ollama import is_available_async, pull_model_async
